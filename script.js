...
// HISTÓRICO REORGANIZADO EM COLUNAS INDEPENDENTES
function renderizarHistorico() {
    ...
    ordenadas.forEach((res) => {
        ...
        const evtNome = res.evento ? res.evento : `<span style="color:#a0aec0; font-style:italic;">Não definido</span>`;
        const obsTexto = res.obs ? res.obs : `<span style="color:#a0aec0; font-style:italic;">Sem notas</span>`;
