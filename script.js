...
// FUNÇÃO CORRIGIDA PARA ADICIONAR AS LINHAS DE DATA COM ESTILO COMPATÍVEL
...
function abrirForm(data, equip, idFirebase = -1) {
    ...
    // Limpar tudo para evitar misturar dados antigos
    ...
    if (idFirebase !== -1) {
        ...
        // MODO NOVA RESERVA MÚLTIPLA (Corrigido os botões e textos)
        ...
        // Ativar a checkbox do equipamento verificado
        checkboxes.forEach(cb => {
            if (cb.value === equip) cb.checked = true;
        });
        
        // Criar a primeira linha com o dia verificado
        adicionarNovaLinhaData(data);
        
        // GARANTIR QUE DIZ GRAVAR TUDO E NÃO ATUALIZAR
...
document.getElementById('reservaForm').addEventListener('submit', function(e) {
    ...
    if (idFirebase !== "-1") {
        ...
        // Enviar os dados combinados para a nuvem
